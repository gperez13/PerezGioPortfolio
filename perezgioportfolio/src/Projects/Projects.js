				...
				<div id="projects">
					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<h4>Rate My Chicago Alderman</h4>
							<br/>

								<p>Rate My Chicago Alderman is a politician rating project aimed at engaging Chicago citizens in 
						...
						<div class="row">
							...
							<div class="col-md-5">
									...
									<p>This is a video game resembling one of many space shooter games from the 80's.  
						...
						<div class="row">
							...
							<div class="col-md-5">
								...
								<h4>LASA</h4>
								<br/>
									<p>I am working on a project that crowd sources personal healthcare practices to support mental health. The project will include a RESTful structure and a database that receives crowd sourced information. Research has been conducted with mental health professionals and lawyers to ensure the best outcome for users. We expect a launch by January 2018.
